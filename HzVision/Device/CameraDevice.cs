...
namespace HzVision.Device
{
    ...
    public class CameraDevice : IGrabHImage, IDisposable
    {
        ...
        public void CameraSoft()
        {
            ...
            {
                CompleteSoft.Reset();
                bool flag = cameraAPIHandle.SoftTriggerOnce();
                //if (hHImage.IsInitialized() == false && string.IsNullOrWhiteSpace(FileName) == false)
                //{
                //    hHImage = new HImage(FileName);
                //}
